...
f + geom_mosaic(aes(x = product(FieldOfStudy),
  ...
  scale_y_discrete(breaks = c("Common Only",  "Ecological (with or without Common)", "Functional (with or without Common)",
                              "Host-adapted (with or without Common)", "Temporal (All Combinations)", "None"), 
                   labels = c("Common Only", "Ecological \n (with or without Common)", "Functional \n (with or without Common)",
                              "Host-adapted \n (with or without Common)", "Temporal \n (All Combinations)", "None"))
